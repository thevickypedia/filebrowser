        ...
        <div class="card-content">
          ...
          >
            <a
              class="link"
              target="_blank"
              href="https://github.com/thevickypedia/filebrowser/blob/master/docs/configuration.md#custom-branding"
        ...
        <div class="card-content">
          ...
          >
            ...
            <a
              class="link"
              target="_blank"
              href="https://github.com/thevickypedia/filebrowser/blob/master/docs/configuration.md#command-runner"
              >{{ t("settings.documentation") }}</a
            >
          </i18n-t>
